...
my_task_template = """You are an agent that is trained to perform some basic tasks on a smartphone. You will be given a 
...
press, or swipe.
<ui_document>
The task you need to complete is to <task_description>. And you <attitude> current video.
